...
public class ManualString {
	 ...
	 * 
	 * EN JAVA HEMOS VISTO QUE CUANDO QUEREMOS ALMACENAR UN VALOR ENTERO DEFINIMOS UNA VARIABLE DE TIPO int, SI QUEREMOS
	 ...
	 * 
	 * UNA CADENA DE CARATERES NO DEJA DE SER MAS QUE UNA SUCESION DE UN CONJUNTO DE CARATERES ALFANUMERICOS, PODEMOS 
	 * ENCONTRARNOS DESDE LA ARCHICONOCIDA CADENA "hola mundo" Y LA NO MENOS "mi primera pagina web", PASANDO POR LAS
	 ...
	 * UNA VARIABLE DE TIPO TEXTO SE DEBE ESCRIBIR LA CLASE "String" SEGUIDO DEL NOMBRE DE LA VARIABLE MAS EL VALOR DE
	 * DICHA VARIANLE SEGUIDO DE PUNTO Y COMO, CABE RECORDAR QUE EN JAVA TODASS LAS VARIABLES DEBEN CULMINAR EN PUNTO 
	 * Y COMA, EJEMPLO :
	 * 
	 ...
	 * 	String cadena = "El que se fue a Sevilla perdio su silla y el que se fue al Torreon, su sillon";
       ...
       NOTA : PARA CONTAR LA CADENA DE CARACTERES SIEMPRE COMIENZA POR CERO, UNO, DOS TRES .... Y ASI SUCESIVAMENTE
       EN EL EJEMPLO DE ARRIBA EL RESULTAO ES E PORQUE LA PRIMERA LETRA DE LA CADENA QUE CONTIENE LA VARIABLE CADENA ES
       COMIENZA CON "E", EN EL PARAMETRO DEL METODO charAt(0) PASAMOS COMO PARAMETRO EL CERO QUE CORRESPONDE A LA 
       POSICION DE LA LETRA DE LA CADENA.  
	 *******************************************************************************************************************
	 *******************************************************************************************************************
	 ...
	 *******************************************************************************************************************
	 *******************************************************************************************************************
	 * equals() : EL METODO "equals" RETORNA VERDADERO SI LOS CONTENIDOS DE LOS DOS STRING SON EXACTAMENTE IGUALES, 
	 * EJEMPLO :
	 ...
	 * NOTA : PARA COMPARAR SI EL CONTENIDO DE LOS String SON IGUALES NO PODEMOS UTILIZAR EL OPERADOR == DEBEMOS 
	 * UTILIZAR UN METODO DE LA CLASE String LLAMADO equals Y PASAR COMO PARAMETROD RL STRINGCON EL QUE QUEREMOS 
	 * COMPARARLO
	 *******************************************************************************************************************
	 *******************************************************************************************************************
	 * equalsIgnoreCase() : ES IGUAL AL METODO equals LA DIFERENECIA ES QUE ESTE METODO IGNORA LAS MAYUSCULAS Y LAS 
	 * MINUSCULAS, EJEMPLO :
	 * 
	 *  String apellido1 = "Herrera";
	 *  String apellido2 = "herrera";
	 ...
	 *******************************************************************************************************************
	 *******************************************************************************************************************
	 * substring() : SE UTILIZA PARA OBTENER LA SUBCADENA DE UNA CADENA DADA, EN FUNCION DE LOS PARAMETROS ESPECIFICADOS
	 * ESTE METODO SE LE PASAN DOS PARAMETROS EL PRIMERO ES DE DESDE DONDE COMENZARA A CONTAR LA CADENA, Y EL SEUNDO 
	 * PARAMETRO ES EL FINAL DONDE TERMINA LA CADENA EJEMPLO :
	 * 
	 ...
	 *******************************************************************************************************************
	 *******************************************************************************************************************
	 * concat() : ESTE METODO PERMITE COMBINAR UNA CADENA ESPECIFICADA AL FINAL DE ESTA CADENA, DEVUELVE UNA CADENA, ES
	 * COMO AGREGAR OTRA CADENA, EJEMPLO :
	 * 
	 ...
	 *******************************************************************************************************************
	 *******************************************************************************************************************
	 * endsWith() : ESTE METODO COMPRUEBA SI LA CEDENA TERMNA CON EL SUFIJO DADO. DEVUELVE VERDADERO SI ESTA CADENA 
	 * TERMINA CON EL SIFIJO DADO, DE LO CONTRARIO DEVUELVE FALSO, EJEMPLO :
	 * 
	 * 	clase pública  EndsWithEjemplo {   
	 * 
		   public static void  main (String args []) { 
	 ...
	 *******************************************************************************************************************
	 *******************************************************************************************************************
	 * valueOf() : ESTE METODO CONVIERTE DIFERENTES TIPOS DE VALORES EN CADENA, CON LA AYUDA DEL METODO String valueOf()
	 * PUEDE CONVERTIR int a String, LARGO long a String, boolean a String, char a String, float a String, double a 
	 * String, object a String, char a arrays a string, EJEMPLO :
	 * 
	 * 	clase públic  ValueOfEjemplo{  
	 *  
		   public static void  main (String args []) {    
		    int valor = 30;  
	 ...
	 *******************************************************************************************************************
	 *******************************************************************************************************************
	 * split() : ESTE METODO DIVIDE UNA CADENA DADA Y DEVUELVE UN ARRAYS, ES DECIR TRANSFORMA UNA CADENA EN UN ARRAYS,
	 * EJEPMLO : 
	 * 
	 *  Clase públic  SplitEjemplo {   
	 ...
	 *******************************************************************************************************************
	 ******************************************************************************************************************* 
	 * isEmpty() : ESTE METODO COMPRUEBA SI LA CADENA ESTA VACIA O NO. DEVUELVE VERDADERO SI LA LONGITUD DE LA CADENA ES 
	 * CERO, DE LO CONTRARIO ES FALSO, EN OTRAS PALABRAS, SE DEVUELVE VERDADERO SI LA CADENA ESTA VACIA; DE LO CONTRARIO
	 * DEVUELVE FALSO, EJEMPLO :
	 * 
	 * 	clase públic  IsEmptyEjemplo {  
