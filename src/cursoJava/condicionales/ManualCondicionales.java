...
public class ManualCondicionales {
	 ...
	 *  
	 *  LA TOMA DE DECICIONES EN LA PROGRAMACION ES SIMILAR A LA TOMA DE DECISIONES EN LA VIDA REAL. EN LA PROGRAMACION 
	 *  TAMBIEN ENFRENTAMOS ALGUNAS SITUACIONES EN LAS QUE QUEREMOS QUE SE EJECUTE CIERTO BLOQUE DE CODIGO CUANDO SE 
	 *  CUMPLE UNA COMDICION, UN LENGUAJE DE PROGRAMACION UTILIZA INSTRUCCIONES DE CONTROL PARA CONTROLAR EL FLUJO DE 
	 *  EJECUCION DEL PROGRAMA EN FUNCION DE CIERTAS CONDICIONES. ESTOS SE UTILIZAN PARA HACER QUE EL FLUJO DE EJECUCION 
	 *  AVANCE Y SE RAMIFIQUE EM FUNCION DE LOS CAMBIOS EN EL ESTADO DE UN PROGRAMA.
	 *  
	 *  EN JAVA EXISTEN VARIOS TIPOS DE CONDICIONALES QUE PODEMOS UTILIZAR DE ACORDE A LA NECESIDAD QUE SE REQUIERA AL 
	 *  MOMENTO, LOS CONDICONALES QUE PRESENTAREMOS A CONTINUACION SON LOS SIGUIENTES :
	 *******************************************************************************************************************
	 *******************************************************************************************************************
	 *  if : LA SENTENCIA "if" SE USA PARA ESPECIFICAR UN BLOQUE DE CODIGO QUE SE EJECUTARA, SI UNA CONDICION ES 
	 *  PECIFICADA ES VERDADERA EJEMPLO :
	   
	   if (20 > 18) { 
           System.out.println("20 es mayor que 18");    // esto se lee asi: si 20 es mayor
                                                           que 18 entonces --> "20 es mayor que 18"
        }
      
      NOTA : LA CONDICION DENTRO DE LA SENTENCIA if DEBE SER UNA EXPRESION "BOOLEANA" ES DECIR DEBE DEVOLVER UN VALOR 
	 *******************************************************************************************************************
	 *******************************************************************************************************************
	 * else :  LA SENTENCIA else SE USA PARA ESPECIFICAR UN BLOQUE DE CODIGO QUE SE EJECUTARA, SI UNA CONDICION ES 
	 * PECIFICADA ES FALSA EJEMPLO :
     ...
     NOTA : LA DECLARACION IF SOLO NOS DICE QUE, SI UNA CONDICION ES VERDADERA EJECUTARA UN BLOQUE DE INSTRUCCIONES Y SI 
     LA CONDICION ES FALSA. NO LO HARA. PERO ¿Y SI QUEREMOS HACER OTRA COSA CUANDO LA CONDICION SEA FALSA? AQUI VIENE LA
     DECLARACION ELSE. PODEMOS USAR LA DECLARACION ELSE CON LA INSTRUCCION else CON LA INSTRUCCION if PARA EJECUTAR UN 
     BLOQUE DE CODIGO CUANDO LA CONDICION SEA FALSA   
	 ********************************************************************************************************************
	 ...
	 * 
	 * 
     NOTA : EN EL EJEMPLO ANTERIOR, LA VARIABLE time(22) ES MAYOR QUE 10, POR LO QUE LA PRIMERA CONDICION ES false. LA 
     SIGUIENTE CONDICION EN EL else if TAMBIEN ES false, ASI PASAMOS A AL else, YA QUE LA CONDICION1 Y LA CONDICION2 SON 
     AMBAS false, E IMPRIMIMOS EN LA PANTALLA "Buenas noches", SIN EMBARGO SI LA VARIABLE time FUERA 14, NUESTRO PROGRAMA
     EN LA PANTALLA  IMPRIMIRIA "Buen día".
	 ********************************************************************************************************************
	 ********************************************************************************************************************
	 ...
	 *******************************************************************************************************************
	 *******************************************************************************************************************
	 * CONDICONALES SWITCH : LA INSTRUCCION SWITCH ES UNA DECLARACION DE BIFURCACION DE MULTIPLES VIAS ("SELECCION 
	 * MULTIPLES"). PROPORCIONA UNA FORMA SENCILLA DE ENVIAR LA EJECUCION A DIFERENTES PARTES DEL CODIGO EN FUNCION DEL 
	 * VALOR DE LA EXPRESION EJEMPLO :
	 * 
	 * public class MyClass {
	 * 
        public static void main(String[] args) {
    ...
    ********************************************************************************************************************
    ...
    1 - CONFECCIONAR UN PROGRAMA QUE PIDA POR TECLADO TRES NOTAS DE UN ALUNNO, CALCULE EL PROMEDIO E IMPRIMA ALGUNO DE 
    ...
    3 - SE INGRESAN POR TECLADO UN VALOR ENTERO, MOSTRAR UN MENSAJE QUE INDIQUE SI EL NUMERO ES POSITIVO, NULO O 
       NEGATIVO.
    
    4 - CONFECCIONAR UN PROGRAMA QUE PERMITA CARGAR UN NUMERO ENTERO POSITIVO DE HASTA TRES CIFRAS Y MUESTRE UN MENSAJE 
        INDICANDO SI TIENE 1, 2, 3 CIFRAS. MOSTRAR UN MENSAJE DE ERROR SI EL NUMERO DE CIFRAS ES MAYOR.
        
    5 - UN POSTULANTE A UN EMPLEO, REALIZA UN TEST DE CAPACITACION, SE OBTUVO LA SIGUIENTE INFORMACION: CANTIDAD TOTAL DE
