...
public class ManualOperadores {
	 ...
	 *******************************************************************************************************************
	 *******************************************************************************************************************
	 * OPERADORES UNARIOS : LOS OPETADORES UNARIOS SOLO NECESITAN UN OPERANDO, SE USAN PARA INCREMENTAR, DISMINUIR O 
	 * NEGAR UN VALOR :
	 * 
	 ...
	 *******************************************************************************************************************
	 *******************************************************************************************************************
	 * OPERADORES RELACIONALES : LOS OPERADORES RELACIONALESM SE UTILIZAN PARA COMPARAR VALORES, POR LO GENERAL ESTOS 
	 ...
	 *******************************************************************************************************************
	 *******************************************************************************************************************
	 * OPERADOR LOGICO OR : SE ESCRIBE CON LA PALABRA RESERVADA || ESTE OPERADOR DEVUELVE VERDADERO (true) SI ALGUNA DE 
	 * LAS SENTENCIA ES VERDADERA EJEMPLO :
	 * 
	 ...
	 *******************************************************************************************************************
	 *******************************************************************************************************************
	 * OPERADOR LOGICO DE NEGACION O DISTINTO != : SE ESCRIBE CON LA PALABRA RESERVADA ! Y SE USA PARA NEGAR 
	 * INSTRUCCIONES DE CODIGO, EJEMPLO :
	 *  
	 ...
	 *******************************************************************************************************************
	 *******************************************************************************************************************
	 * OPERADOR TERNARIO : EL OPERADOR TERNARIO ES UNA VERSION ABREVIADA DE LA DECLARACION IF-ELSE ESTE OPERADOR CUENTA 
	 * CON TRES OERANDO DE ALLI EN NOMBRE DE TERNARIO, EL FORMAO GENERAL ES (condicion ? if true : if false) ESTE 
	 * OPERADOR CONSTA DE TRES OPERANDO, PRIMERO LA CONDICION DETRO DE PARENTESIS, EL ? QUE REPRESENTA LA CONDICON TRUE, 
	 * Y EL : REPRESENTA LA CONDICION FALSEEJEMPLO :
	 * 
