...
public class Manual_de_Variables {
	 ...
	 * VARIABLES EN JAVA :
	 * 
	 * UNA VARIABLE ES UN ESPACIO EN LA MEMORIA DEL ORDENADOR QUE ALMACENA UN DETERMINADO VALOR, UNA VARIABLE EN JAVA 
	   PUEDE CAMBIAR DE VALOR  MEDIANTE LA EJECUCION DE UN PROGRAMA, CABE DESTACAR QUE LAS VARIABLES EN JAVA SE DEBEN 
	   PRIMERO DECLARAR Y LUEGO INICIALIZAR ANTES DE SER UTILIZADAS, O DE LO CONTARIO PROVOCARIA UN ERROR EN EL 
	   PROGRAMA, UNA VARIABLE EN JAVA DEBE TERMINAR EN PUNTO Y COMA.
	   
	   PARA CREAR UNA VARIABLE EN JAVA TIENES ESCRIBIR TRES CARACTERISTICAS, "EL TIPO DE DATOS", "EL NOMBRE DE LA 
	   VARIABLE", "Y EL VALOR DE LA VARIABLE", EJEMPLO:
	 * 
	 * int edad = 34;
	 * 
	 ...
	 * 
	 * LAS VARIABLES EN JAVA NO DEBEN COMENZAR CON NUMEROS NI CARACTERES EXTRAÑOS, EXISTEN DIFERENCIAS ENTRES VARIABLES
	 * ESCRITA CON MAYUSCULAS, Y VARIABLES ESCRITA EN MINUSCULA. ES RECOMENDABLE ESCRIBIR LOS NOMBRES DE LA VARIABLES CON
	 * LA PRIMERA PALABRA EN MINUSCULA. NO ES LO MISMO int EDAD = 35; QUE  int edad = 35;
	 * JAVA ES UN LENGUAJE INTELICENSE, ES DECIR SE PUEDE ESCRIBIR PALABRAS EN MAYUSCULAS INTERCALADAS CON MINUSCULAS
	 * EJEMPLO :
	 * 
	 ...
	 * 
	 * PARA IMPRIMIR O MOSTRAR EL VALOR DE LAS VARIABLES CREADAS EN JAVA EXISTEN VARIOS METODOS QUE PERMITEN MOSTAR POR
	 * CONSOLA EL VALOR ASIGNADO A LA VARIABLES, PARA ELLO UTILIZAMOS EL METODO "print" o "println", EJEMPLO :
	 * 
	 * int edad1 = 35;
	 * int edad2 = 40;
	 * 
	 * // MOSTRAMOS EL VALOR DE LAS VARIABLES POR CONSOLA. 
	 * System.out.print(edad1);
	 * System.out.println(edad2);
	 * 
	 * NOTA : LA DIFERENCIA QUE EXISTEN ENTRE EL METODO print Y EL METODO println ES QUE EL METODO println AGREGA UN
	 * SALTO DE LINEA. ES MUY IMPORTANTE UTILIZAR ESTOS METODOS PARA PODER VISIALIZAR EL RESULTADO DE LAS VARIABLES.
	 * 
	 ...
	 ********************************************************************************************************************
	 ********************************************************************************************************************
	 * AMBITO DE UNA VARIABLE : LAS VARIABLES TIENEN DIFERENTES AMBITOS, PUEDEN SER AMBITOS LOCALES O AMBITOS GLOBALES, 
	 * ES DECIR LAS VARIABLES QUE SE DECLARAN EN LA CLASE SON VARIABLES GLOBALES A LO QUE SE LLAMA VARIABLES DE 
	 * INSTANCIA, Y LAS VARIABLES QUE SE DECLARAN DENTRO DE LOS METODOS O FUNCIONES SON VARIABLES LOCALES EJEMPLO :
	 * 
	 ...
	 *     
	 * 4 - REALIZAR UN PROGRAMA QUE PERMITA CREAR DOS VARIABLES LOCALES CON SU NOMBRE Y SU EDAD, IMPRIMIR POR PANTALLA 
	 *     EL RESULTADO.
	 * 
	 * 5 - REALIZAR UN PROGRAMA QUE PERMITA CREAR DOS VARIABLES DE INSTANCIA CON SU NOMBRE Y SU EDAD, IMPRIMIR POR 
