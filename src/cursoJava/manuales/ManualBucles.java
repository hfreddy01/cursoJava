...
public class ManualBucles {
	 ...
	 * UTILES POERQUE AHORRAN TIEMPO, REDUCEN ERRORES Y HACEN QUE EL CODIGO SEA MAS LEGIBLE.
	 * 
	 * UN BUCLE O ESTRUCTURA REPETITIVA PERMITE EJECUTAR UNA INSTRUCCION O UN CONJUNTO DE INSTRUCCIONES VARIAS VECES
	 * UN BUCLE REPETITIVO SE CARATERIZA POR :
	 *  - LA O LAS SENTENCIAS QUE SE REPITEN.
	 *  - EL TEST O PRUEBA DE CONDICION ANTES DE CADA REPETICION, QUE MOTIVARA QUE SE REPITAN O NO LA SENTENCIAS.
	 *****************************************************************************************************************
	 *****************************************************************************************************************
	 * BUCLE WHILE : EL BUCLE "while" SE UTILIZA PARA RECORRER UN BLOQUE DE CODIGO SIEMPRE QUE UNA CONDICION SEA
	 * VERDADERA (true), SE ESCRIBE CON LA PALABRA RESERVADA (while), SE DEBE DECLARAR E INICIALIZAR UNA VARIABLE
	 * EJEMPLO :
	 * 
	 * int i = 0;
		while(i < 5) {			     ejemplo
	   ...
	   NOTA : NO OLVIDE INCREMENTAR LA VARIABLE CON EL OPERADOR ++ LA VARIABLE UTILIZADA EN LA CONDICION DEBE SER
	   INCREMENTADA, O DE LO CONTRARIO EL CICLO NUNCA TERMINARA.
	 ******************************************************************************************************************
	 ******************************************************************************************************************
	 ...
	 ******************************************************************************************************************
	 ******************************************************************************************************************
	 * BUCLE FOR : CUANDO SEPA EXACTAMENTE CUANTAS VECES DESEA RECORRER UN BLOQUE DE CODIGO, USE EL BUCLE for, EN LUGAR
	 * DEL BUCLE "while", ESTE BUCLE CONSTA DE TRES PARAMETROS LOS CUALES SON : 
	 * 
