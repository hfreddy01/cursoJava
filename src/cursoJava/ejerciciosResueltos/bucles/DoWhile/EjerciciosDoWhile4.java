...
public class EjerciciosDoWhile4 {
	...
	public static void main(String[] args) {
		// MENSAJE.
		JOptionPane.showMessageDialog(null, " 4 - REALIZAR UN PROGRAMA QUE ACOMULE(SUME) VALORES INGRESAODS POR TECLADO HASTA "
		+ "INGRESAR EL 999 (NO SUMAR DICHO\r\n" + "VALOR INDICAR QUE HA FINALIZADO LA CARGA). IMPRIMIR EL VALOR ACOMULADO E "
		+ "INFORMAR SI DICHO VALOR ES CERO,\r\n" + "MAYOR A CERO O MENOR A CERO.");
