...
public class EjerciciosMatriz4 {
	...
	public void getVentanaDatos() {
		// MENSAJE.
		JOptionPane.showMessageDialog(null, "4 - CREAR UNA MATRIZ DE 2 FILAS Y 5 COLUNNAS. REAILIZAR LA CARGA DE COMPONENTES "
		+ "POR COLUNNA, ES DECIR PRIMERO \r\n" + "INGRESAR TODA LA PRIMERA COLUNNA, LUEGO LA SEGUNDA COLUNNA Y ASI SUCESIVAMENTE. "
